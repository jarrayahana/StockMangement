  ...
  return (
    ...
    shadow-xs mt-32 mb-20">
        <div className="max-w-2xl mx-auto text-center">
            <div className="size-16 bg-white roounded-xl flex-center
            mx-auto mb-6 shadow">
            ...
            <p className="text-app-text-light mb-8 text-base">
                Get weekly updates on fresh produce ,seasonal offers, and 
                exclusive discounts right to yoour inbox.
            </p>
            ...
            max-w-md mx-auto">
                ...
                text-white fotn-semibold rounded-xl hover:bg-app-green-light 
                transition-colors shadow-sm whitespace-nowrap active:scale-[0.98]">
                    Subscribe
                </button>
            </form>
        </div>
