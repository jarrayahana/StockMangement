...
const CartSidebar = () => {
    ...
    const {items,updateQuantity,removeFromCart,cartTotal,
        isCartOpen,setIsCartOpen} =useCart()
  ...
  return (
    <>
        ...
        shadow-2xl flex flex-col animate-slide-in-right">
            ...
            p-5 border-b border-app-border">
            ...
            <div  className="flex-1 overflow-y-auto p-5 space-y-4">
                {items.length ===0 ? (
                    ...
                    items.map((item)=>(
                        ...
                        bg-app-cream/60 rounded-xl p-3"> 
                                ...
                                <div className="flex items-center justify-between mt-2">
                                    ...
                                    <div className="flex items-center gap-2"> 
                                        ...
                                        <button onClick={()=>removeFromCart(item.product._id)}
                                            className="p-1 text-app-text-light hover:text-app-error
                                            transition-colors">
            ...
            {items.length > 0 &&(
                <div className="p-5 border-t border-app-border space-y-3"> 
                    ...
                    {deliveryFee >0 && <p className="text-xs text-app-text-light
                    text-center">Free delivery on orders over {currency} 20! </p> }
                    ...
                    <button onClick={()=> {setIsCartOpen(false); navigate('/checkout');window.scrollTo(0,0)}}
                        className="w-full py-3 bg-app-orange text-white fotn-semibold
                        rounded-xl hover:bg-app-orange-dark transition-colors flex-center gap-2 active:scale-[0.98]">
                        Proceed to CheckOut
