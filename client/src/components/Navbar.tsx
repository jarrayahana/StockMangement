  ...
  return (
    ...
    border-app-border">
        ...
        flex items-center justify-between h-16 gap-4">
            {/* Logo */}
            <Link to='/' className="flex iteems-center gap-2
            text-[22px] font-medium shrink-0">
                <TruckIcon size={24}/> Instacart
            </Link>
            ...
            gap-4 lg:gap-10">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <ShoppingCartIcon className="size-5 text-zinc-900"/>
                        ...
                        -right-1 size-4 bg-app-orange text-white
                    ...
                    <div className="relative">
                        {user ? (
                            ...
                            <div className="flex-center gap-2">
                                <Link to='/login' className="hidden md:flex items-center gap-22 px-4 text-sm font-medium
                                text-white bg-green-950 rounded-full hover:bg-green-950-light transition-colors" >
                                <UserIcon size={16}/>
                                    Sign In
                                </Link>
                                {userMenuOpen ? <XIcon 
                        ...
                        {userMenuOpen && (
                            ...
                            onClick={()=>setUserMenuOpen(false)}>
                                ...
                                bg-white rounded-xl shadow-lg border border-app-border py-2
                                z-50 animate-fade-in">
                                    ...
                                    <div onClick={()=> setUserMenuOpen(false)}>
                                        ...
                                        {user &&<Link to='/products' className="dropdown-link
                                        md:hidden">
                                        <ArrowUpRightIcon size={16}/>
                                        Products
                                        </Link>}
                                        {user &&<Link to='/deals' className="dropdown-link
                                        md:hidden">
                                        <ArrowUpRightIcon size={16}/>
                                        Deals
                                        </Link>}
                                            {user?.isAdmin && (<Link to='/admin/products' className="dropdown-link">
