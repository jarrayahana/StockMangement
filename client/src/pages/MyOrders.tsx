      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          {tabs.map((tab)=> (
            ...
            className={`px-4 py-2 text-sm font-medium rounded-xl whitespace-nowrap
            tranisiton-colors ${activetab===tab ? 
        ...
        {loading ? (
          ...
          <div className="text-center py-16"> 
            ...
            <Link 
            className="inline-flex px-4 py-2 bg-app-green 
          ...
          <div className="space-y-4">
            {orders.map((order)=>(
              ...
              className="block max-w-4xl bg-white rounded-2xl p-5 hoverr:shadow 
              transition-all">
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-xs text-app-text-light">{new Date(order.createdAt).
                  ...
                  <div className="flex items-center gap-2">
                      <span className={`px-4 py-1 text-xs font-medium
                        rounded-full ${statusColors[order.status] || 
                ...
                <div className="flex items-center gap-2 mb-3">
                    ...
                    ))}
                    {
                      ...
                      rounded-lg bg-app-cream flex-center text-xs
                      font-semi-bold text-app-text-light"> 
                        + {order.items.length - 4}
                      </div>
                    }
                </div>
                {/* total Items & price*/}
                <div className="flex 
                justify-between items-center pt-3 text-sm ">
