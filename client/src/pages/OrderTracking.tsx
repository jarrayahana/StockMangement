...
const OrderTracking = () => {
  ...
  if(!order) null
  return (
    <div className="min-h-scream mb-20 bg-app-cream">
      <div className="max-w-6xl mx-auto px-4 sm:px6 lg:px-8 py-8">
        {/* Header */}
        <button onClick={()=> navigate("/orders")}
          className="flex items-center gap-2 text-sm 
          text-app-text-light hover:text-app-green 
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-app-text-light mt-1">Placed 
          ...
          <span className={`px-4 py-1.5 text-sm font-semibold 
            rounded-full ${order!.status=== "Delivered" ? 
            "bg-green-100 text-green-700": order!.status==="Cancelled"? 
            "bg-red-100 text-red-700":"bg-app-orange/10 text-app-orange"}`}>
            {order!.status}
          </span>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              {/*Delivery Person */}
              {order?.deliveryPartner && order.status !==
                  ...
                  <div className="flex items-center gap-3"> 
                    ...
                    <div>
                      <p className="text-sm font-semibold text-app-green">
                        {order.deliveryPartner.name}</p>
                      <p className="text-xs text-app-text-light 
                      capitalize">{order.deliveryPartner.vehicleType} * Delivery
                        Partner
                      </p>
                    </div>
                  </div>
                  <a href={`tel:${order.deliveryPartner.phone}`} className="p-2.5 bg-app-cream rounded-xl 
                  hover:bg-app-cream-dark transition-colors">
            ...
            <div className="bg-white rounded-2xl p-5">
              ...
              <p className="text-sm text-app-text-light leading-relaxed">
                ...
                <div className="bg-white rounded-2xl p-5">
                  ...
                  <div className="mt-4 pt-3 border-t bordr-app-border space-y-1.5
                    text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{order?.deliveryFee ===0 ? "Free":`${currency}
                    ...
                    border-app-border font-semibold text-app-green">
                      <span >Total </span>
