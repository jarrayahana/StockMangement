  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        text-sm test-app-text-light hover:text-app-green transition-colors">
          <ArrowLeftIcon />Back
        </button>
        ...
        <div className="bg-white/50 rounded-2xl overflow-hidden">
           <div className="grid md:grid-cols-2 gap-0">
              ...
              min-h-[320px] md:miin-h-[480px]">
                <img src={product.image} alt={product.name}
                className="max-h-[360px] w-auto object-contain"/>
              {/* Badges */}
              <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                {product.isOrganic && (
                  <span className="flex items-cnter gap-1 px-2.5 py-1
              ...
              <div className="p-6 md:p-10 flex flex-col justify-center">
                  ...
                  <div className="flex items-baseline gap-3 mb-5">
                    ...
                    text-app-green">{currency}{product.price.toFixed(2)}

                    </span>
                    {product.originalPrice > product.price &&(
                      <span 
                      className="text-lg text-app-text-light 
                      line-through">
                  ...
                  <div className="mb-6">
                    {product.stock > 0 ? (
                      ...
                      font-medium">In Stcok ({product.stock} available)</span>
                    ) :(
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    border-app-border rounded-xl overflow-hidden">
