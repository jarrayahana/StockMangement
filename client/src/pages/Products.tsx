...
const Products = () => {
  ...
  const activeCategory=categoriesData.find((c)=> 
    c.slug ===category);
  ...
  return (
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex gap-8 sl:gap-10">
          { /* Sidebar - Desktop */}
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className='relative'>
                  ...
                  <ChevronDown className="absolute right-2.5 top-1/2 -translate-y-1/2 w-3.5 
            ...
            {loading ? (
              ...
              <div className='text-center py-16'>
                ...
                <button onClick={clearFilters} className='px-5 py-2 font-medium bg-app-green 
            ...
            {totalPages >1 && (
              <div className='flex-center gap-2 mt-16'>
                {Array.from({length: totalPages}).map((_,i)=>(
                  ...
                  font-medium transition-colors ${page=== i+1 ?
                    "bg-app-green text-white ": "bg-white text-app-text-light hover:bg-app-cream"
                   }`}>
                    {i+1}
                  </button>
                ))}
