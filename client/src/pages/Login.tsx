            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    gap-2 mb-6">
                        ...
                        text-app-green">Super Stock</span>
                    </Link>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    {!isLoginState && (
                        <label className="text-sm flex flex-col gap-1">
                            ...
                            <div className="relative">
                                ...
                                -translate-y-1/2 text-app-text-light"/>
                                <input type="text"
                                value={name} 
                                ...
                                rounded-xl border not-focus:border-app-border
                                transition-all"/>
                            </div>
                        </label>
                    )}
                    <label className="text-sm flex flex-col gap-1">
                        ...
                        <button type="submit" 
                        disabled={loading} className="flex-center w-full py-3 bg-green-950
                        text-white font-semibold rounded-xl hover:bg-green-900
