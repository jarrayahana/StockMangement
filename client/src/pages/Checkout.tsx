...
const Checkout = () => {
  ...
  const [address,setAddress]=useState<Address>({
    _id:"",label:"Home",address:"",city:"",state:"",zip:""
  ...
  useState(()=>{
    if(user?.addresses?.length){
      const defaultAddr=user.addresses.
      find((a)=>a.isDefault) || user.addresses[0]
      setAddress({
    _id:defaultAddr?._id,label:defaultAddr?.label,
    address:defaultAddr?.address,city:defaultAddr?.city,
    state:defaultAddr?.state,zip:defaultAddr?.zip
      ...
      <div className="min-h-screen bg-app-cream flex-center">
        <div className="text-center">
          ...
          <button className="px-5 py-2.5
            bg-app-green  text-white text-sm font-medium rounded-xl
  ...
  return (
    <div className="min-h-screen bg-app-cream">
      ...
      items-center gap-2 text-sm text-app-text-ligth hover:text-app-green
        ...
        {steps.map((s,i)=>(
          <div key={s.key} className="flex items-center gap-2">
            ...
            className={`flex items-center gap-2 px-4 py-2
              ...
              ${step === s.key ? "bg-app-green text-white":
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          handlePlaceOrder={handlePlaceOrder} loading={loading}/>          }
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 h-fit sticky top-24">
          ...
          <div className="space-y-2 text-sm">
            ...
            border-app-border text-base font-semibold">
              <span >
                Total
              </span>
